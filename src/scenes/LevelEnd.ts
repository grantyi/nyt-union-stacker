...
export default class LevelEnd extends Phaser.Scene {
  ...
  create() {
    ...
    nextLevelButton.on("pointerup", () => {
      ...
      if (true) {
        // TODO: Set this to do the boss-fight at like lvl 5 and 10 or something
        // TODO: Get more points for boss-fight than regular level-end?
        // this.score.score
        this.scene.launch("boss-fight");
      } else {
